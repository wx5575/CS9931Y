...
#include    "CS8833CInstructionTable.h"
...
static const HeadScaleParserStruct   st_InstructionStruct_Step_8833; 
...
******************************************************************************/ 
//CS2676C根指令容器
const ParserContainer t_ParserContainer_Root_CS8833[7] = {
        ...
        {(void *)&st_InstructionStruct_Step_8833        , PARSER_HEAD_SCALE  },
...
******************************************************************************/
//STEP:IR第三级指令容器
static const ParserContainer st_ParserContainer_StepIr_8833[] = {
...
//STEP:ACW第三级指令容器
static const ParserContainer st_ParserContainer_StepAcw_8833[] = {
...
//STEP:DCW第三级指令容器
static const ParserContainer st_ParserContainer_StepDcw_8833[] = {
...
//STEP:GR第三级指令容器
static const ParserContainer st_ParserContainer_StepGr_8833[] = {
...
static const MidleScaleParserStruct   st_InstructionStruct_StepIr_8833 = {
    
        "IR"  , st_ParserContainer_StepIr_8833, 58, 58, INSTRUCTION_ATTR_NONE, GET_ARRAY_COUNT(st_ParserContainer_StepIr_8833),
    };

static const MidleScaleParserStruct   st_InstructionStruct_StepAcw_8833 = {
    
        "ACW"  , st_ParserContainer_StepAcw_8833, 234, 234, INSTRUCTION_ATTR_NONE, GET_ARRAY_COUNT(st_ParserContainer_StepAcw_8833),
    };

static const MidleScaleParserStruct   st_InstructionStruct_StepDcw_8833 = {
    
        "DCW"  , st_ParserContainer_StepDcw_8833, 171, 171, INSTRUCTION_ATTR_NONE, GET_ARRAY_COUNT(st_ParserContainer_StepDcw_8833),
    };

static const MidleScaleParserStruct   st_InstructionStruct_StepGr_8833 = {
    
        "GR"  , st_ParserContainer_StepGr_8833, 57, 57, INSTRUCTION_ATTR_NONE, GET_ARRAY_COUNT(st_ParserContainer_StepGr_8833),
    };

//-----------------------------------------------------------------------------

//"STEP"第二级指令容器
static const ParserContainer st_ParserContainer_Step_8833[] = {
				{(void *)&st_InstructionStruct_StepMode      , PARSER_TAIL_SCALE},
				{(void *)&st_InstructionStruct_StepIr_8833   , PARSER_MIDDLE_SCALE},
				{(void *)&st_InstructionStruct_StepAcw_8833  , PARSER_MIDDLE_SCALE},
				{(void *)&st_InstructionStruct_StepDcw_8833  , PARSER_MIDDLE_SCALE},
				{(void *)&st_InstructionStruct_StepGr_8833   , PARSER_MIDDLE_SCALE},
    };

//"STEP"指令第一级(根级)
static const HeadScaleParserStruct   st_InstructionStruct_Step_8833 = {
    
        "STEP", st_ParserContainer_Step_8833, 67, 67, INSTRUCTION_ATTR_NONE, GET_ARRAY_COUNT(st_ParserContainer_Step_8833),
    };
