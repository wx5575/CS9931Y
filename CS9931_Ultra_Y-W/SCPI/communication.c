...
typedef union
{
	...
	struct{
		...
		rt_uint16_t	S8             : 1;
		rt_uint16_t	S7             : 1;
		rt_uint16_t	SH             : 1;//¿ª¡¢¹Ø
		rt_uint16_t	SL             : 1;//MD½ÓµØ¡¢¸¡µØ
		rt_uint16_t	singlefault    : 1;//µ¥Ò»¹ÊÕÏ£º¿ª¡¢¹Ø	
		rt_uint16_t	MDpostion      : 6;//MDÎ»ÖÃ£ºMD1¡¢MD2¡¢MD3¡¢MD4	
	}Item;
}LC_MD_COM;//LC Ò½ÓÃ ×ÛºÏÉèÖÃ
...
/* ÎÞÔ´Ê±ÓëÍâ²¿µÄ±äÆµµçÔ´Í¨ÐÅ ·ûºÅ±äÆµµçÔ´µÄÍ¨Ñ¶Ð­Òé */
#else
void USART2_IRQHandler(void)
{
	uint8_t  tx_temp;
...
/**************************************************************
º¯ÊýÃû£ºUsart2_GetKey
¹¦ÄÜ£º  ´Ó´®¿ÚµÃµ½Êý¾Ý
²ÎÊý£º  Ö¸ÏòÊý¾ÝµÄÖ¸Õë
·µ»ØÖµ£ºËùµÃµ½µÄ½á¹û
***************************************************************/
